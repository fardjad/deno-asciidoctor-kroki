...
export function register(registry, context = {}) {
  ...
  const names = ['actdiag', 'blockdiag', 'bpmn', 'bytefield', 'c4plantuml', 'ditaa', 'erd', 'excalidraw', 'graphviz', 'mermaid', 'nomnoml', 'nwdiag', 'packetdiag', 'pikchr', 'plantuml', 'rackdiag', 'seqdiag', 'svgbob', 'umlet', 'vega', 'vegalite', 'wavedrom', 'structurizr'];
